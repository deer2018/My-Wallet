    ...
    <div class="container-fluid">
        ...
        <div class="card ">
            <div class="card-header py-2">
                <h4 class="m-1 font-weight-bold text-gray-800">คณะเทคโนโลยีอุตสาหกรรม</h4>
                <hr>
                <form method="GET" action="{{ url('/faculty04') }}" accept-charset="UTF-8" class="row ">
                    @csrf
                                        ...
                                        <table class="table dataTable">
                                          ...
                                          <tbody>
                                            ...
                                            @if(!empty($select_year))               
                                                    <td><a href="{{ url('/faculty_show/' . $item->id .'/'. $select_year .'/04')  }}" title="รายละเอียด"><button 
                                                        class="btn btn-primary btn-sm"><i class="fas fa-edit" aria-hidden="true"></i></button></a>                                           
                                                    </td>
                                                @else
                                                    <td><a href="{{ url('/faculty_show/' . $item->id .'/'. $yearCheck .'/04')  }}" title="รายละเอียด"><button 
                                                        class="btn btn-primary btn-sm"><i class="fas fa-edit" aria-hidden="true"></i></button></a>                                           
                                                    </td>
                                                @endif
                                          </tbody>
