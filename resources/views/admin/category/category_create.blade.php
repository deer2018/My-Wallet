...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">สร้างหมวดหมู่</div>
                    <div class="card-body">
                        <a href="{{ url('/category') }}" title="Back"><button class="btn btn-warning btn-sm"><i
                        ...
                        <form method="POST" action="{{ url('/category') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            @include ('admin.category.category_form', ['formMode' => 'create'])
